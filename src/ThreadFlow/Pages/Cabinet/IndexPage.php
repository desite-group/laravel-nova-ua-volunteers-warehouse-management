...
class IndexPage extends AbstractPage
{
    protected function show()
    {
        TextOutgoingMessage::make(
            "Дисклеймер: Це АЛЬФА версія бота. На даний момент побудована лише частина функціоналу та пройдене первинне тестування. В Боті можуть бути баги які ми не відловили на тестуванні, якщо ви стикнулись з певною проблемою, будь ласка напишіть @RomanZhyla")
            ->reply();
